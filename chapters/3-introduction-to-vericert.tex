...
\Cref{fig:accumulator_diagram} shows the resulting FSMD architecture. The
...
Verilog. % and prove that it behaves the same as the 3AC according to the Verilog semantics.
