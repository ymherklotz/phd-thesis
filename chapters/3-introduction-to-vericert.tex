...
and may depend on the value of registers.  Hence, an \htl{} program consists of
a map from states to Verilog statements, which update both the state register as
...
is also computed explicitly in each state by modifying the state register.
