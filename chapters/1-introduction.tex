...
\item[Evaluation of Vericert on PolyBench/C] Finally, we evaluate different
  ...
  Bambu HLS~\cite{bambu_hls}.\YH{TODO: Add numbers about the performance here.}
\end{description}
...
\printpublication{herklotz21_empir_study_reliab_high_level_synth_tools}.
...
\printpublication{herklotz21_formal_verif_high_level_synth}.
...
\printpublication{herklotz24_verified_hyperblock_sched}.
...
\begin{description}
\item[FPGA 2020] \printpublication{herklotz20_findin_under_bugs_fpga_synth_tools}.
\item[FCCM 2022] \printpublication{pardalos22_res_sharing_verified_hls}.
\item[CPP 2023] \printpublication{herklotz23_gsa}.
\end{description}
