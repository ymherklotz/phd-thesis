...
and producing a final Verilog design.  \Cref{sec:hg:hyperblock-destruction}
...
\YH{TODO: There is a section in the BRAM section on word-addressable vs
  byte-addressable memories, which is needed here.  Maybe it can be moved here
  instead.}
...
Then, in the case where the predicate \rtlinline`p2` is $\lfalse$, that would
