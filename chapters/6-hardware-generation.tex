...
\begin{mathpar}
  ...
  t = \left(\begin{array}{l}
    ...
    \statereg \blockasgn e_3 \msemi
  \end{array}\right)}%
  {\yhfunction{spec\_ram\_tr}\ \statereg\ r\ d\ d[i \mapsto t]\ i\ n}
  \and
  \inferrule[Predicated Store Transl]{ d[i] = \left(\begin{array}{l}
    \texttt{if(} c\texttt{)}\ r.\mathrm{mem}\texttt{[}e_{1}\texttt{]} \blockasgn
    e_{2}\msemi \arcr
    \statereg \blockasgn e_3\msemi\end{array}\right) \\ t = \left(\begin{array}{l}
      r.\mathrm{u\_en} \blockasgn
  ...
  \inferrule[Load Transl]{ d[i] = \left(\begin{array}{l}
    r_{\mathrm{d}} \blockasgn r.\mathrm{mem}\texttt{[}e_{1}\texttt{]} \arcr
  ...
  \end{array}\right)
  \end{array}}%
  {\yhfunction{spec\_ram\_tr}\ \statereg\ r\ d\ d[i \mapsto t_1; n \mapsto t_2]\ i\ n}
  \and
  ...
  e_2))\\
(\forall c\ r_{\mathrm{d}}\ e_1\ e_2\ldotp d[i] \neq (r_{\mathrm{d}} \blockasgn \mternary{c}{r.\mathrm{mem}\texttt{[}e_{1}\texttt{]}}{r_{\mathrm{d}}}\msemi \statereg \blockasgn e_2))}%
