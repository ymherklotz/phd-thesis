...
\node[bgbox, fill=bgbox4, fit=(rtlpar)(htlmem), inner sep=3mm,minimum width=\linewidth] {};
\end{pgfonlayer}
...
\begin{figure}
  ...
  \begin{tikzpicture}[>=Latex,shorten >=1pt,
    ...
    \node[bb] (initial block) {
      ...
      \mathstateln{2}\phantomsection\label{msln:2}\veriloginline`state = 32'd2;`\\[0.5em]
      ...
      \mathstateln{5}\phantomsection\label{msln:5}\veriloginline`r2 = r4 * r6;`\\[0.5em]
      ...
      \mathstateln{8}\phantomsection\label{msln:8}\veriloginline`r8 = r2 + r10;`\\[0.5em]
...
\mathstateln{10}\phantomsection\label{msln:10}\mathstate{$\interstate{3}{\asgnnonblockingbefore} = \initialstate{\asgnnonblockingbefore}$}\\[0.5em]
      \mathstateln{11}\phantomsection\label{msln:11}\veriloginline`state = r3 ? 32'd3 : state;`\\[0.5em]
