...
includes all the optimisations from the list scheduling pass such as
hash-consing.  In addition,

However, in contrast to the list scheduling transformation, the superblock
transformation requires validation of symbolic states at each exit of the
