...
support such an equivalence checks, such as Siemens'
SLEC~\cite[]{chauhan20_formal_ensur_equiv_c_rtl}, Cadence's
C2RTL~\cite[]{cadence23_j} or Synopsys' HECTOR~\cite{koelbl21_vcddh}, which try
...
In addition to the commercial tools mentioned previously, there has been
research on verifying specific \gls{HLS} optimisations correct as well, such as
...
verifying algorithm might give false positives.
...
to the internal \gls{IR}, as well as checkes for the final translation from the
...
There has also been work proving HLS correct without using translation
