...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.6\linewidth}
    \centering
    \begin{tikzpicture}[imparrow/.style={shorten >=1pt,>=Latex,->}]
      \node (s1) {$s_1$};
      ...
      \end{scope}
    \end{tikzpicture}
  \caption{Backwards simulation diagrams.}%
  ...
  \begin{subfigure}[t]{0.35\linewidth}
    ...
    \begin{tikzpicture}[imparrow/.style={shorten >=1pt,>=Latex,->}]
      ...
      \draw (s1) -- node[above] {$\approx$} (t1);
    \end{tikzpicture}
    \caption{Progress property needed for the backwards simulation.}%
    \label{fig:bg:backwards-progress-property}
  \end{subfigure}
  \caption{Examples of simulation diagrams that make up the backwards
    simulation.}%
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.48\linewidth}
    ...
    \end{tikzpicture}
  \end{subfigure}
  \caption{Forwards simulation diagrams.}%
...
Several \gls{HLS} tools are associated with translation validators, either for
