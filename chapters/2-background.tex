...
expressions in terms of initial values of registers.  As long as one can show
that equivalence of symbolic expressions and equivalence of symbolic states
implies equivalent behaviour of the original block of code, one can validate
code transformations that will not affect the symbolic representation.
