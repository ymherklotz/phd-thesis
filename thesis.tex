...
\newterm[name={``plus'' forward simulation},sort=plusforwardsimulation]{plus-forward-simulation}
\newterm[name={``star'' forward simulation},sort=starforwardsimulation]{star-forward-simulation}
\newterm{CompCert}
