...
\newglossaryentry{RTL}{type=\acronymtype, name={\textsc{Rtl}},
  description={register transfer language}, first={register transfer language
    (\textsc{Rtl})}}
\newacronym{VLIW}{VLIW}{very large instruction word}
\newacronym{DRAM}{DRAM}{dynamic random-access memory}
\newglossaryentry{BTL}{type=\acronymtype, name={\textsc{Btl}},
  description={block transfer language}, first={block transfer language
    (\textsc{Btl})}}
